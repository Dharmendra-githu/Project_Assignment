      ...
      <div className="container mx-auto">
        <div className="p-8">
          ...
          <div className="mt-3 ps-2">
            <h1 className="font-medium text-xl mb-3 text-blue-700">CSPM dashboard</h1>
          ...
          <div className="pt-4 ps-2">
            <h1 className="font-medium text-xl mb-3 text-blue-700">CWPP dashboard</h1>
            <div className="gap-3 grid grid-cols-1 md:grid-cols-3 justify-items-center">
              {state?.CWPP?.map((el, i) => (
                <WidgetComp
                  widgetName={el?.widgetName}
          ...
          <div className="pt-4 ps-2">
            <h1 className="font-medium text-xl mb-3 text-blue-700">Ticket dashboard</h1>
            <div className="gap-3 grid grid-cols-1 md:grid-cols-3 justify-items-center">
          ...
          <div className="pt-4 ps-2">
            <h1 className="font-medium text-xl mb-3 text-blue-700">Image dashboard</h1>
            <div className="gap-3 grid grid-cols-1 md:grid-cols-3 justify-items-center">
